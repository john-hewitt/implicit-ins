...
# # Evaluating baseline 7B model using chat format, getting the truth and info scores and multiple choice accuracy
python -m eval.truthfulqa.run_eval \
    --data_dir data/eval/truthfulqa \
    --save_dir results/trutufulqa/lima_baseline_7B/ \
    --model_name_or_path  output//lima_baseline_7B/ \
    --tokenizer_name_or_path  output//lima_baseline_7B/ \
...
# # Evaluating noins 7b model using chat format, getting the truth and info scores and multiple choice accuracy
python -m eval.truthfulqa.run_eval \
    --data_dir data/eval/truthfulqa \
    --save_dir results/trutufulqa/lima_noins_7B/ \
    --model_name_or_path  output//lima_noins_7B/ \
    --tokenizer_name_or_path  output//lima_noins_7B/ \
    --metrics truth info mc \
    --preset qa \
    --hf_truth_model_name_or_path allenai/truthfulqa-truth-judge-llama2-7B \
    --hf_info_model_name_or_path allenai/truthfulqa-info-judge-llama2-7B \
